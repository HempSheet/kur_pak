...
class GameController(object):
    def __init__(self):
        ...
        self.eat_sound = pygame.mixer.Sound("nomnom.wav")
        self.start_game = pygame.mixer.Sound("newGame.wav")
        ...
        if not self.gameover:
            ...
            if not self.pause.paused:
                ...
                if self.pacman.animateDeath:
                    ...
                    self.eat_sound = pygame.mixer.Sound("death.wav")
                    self.eat_sound.play()
    ...
    def checkPelletEvents(self):
        ...
        if pellet:
            pygame.mixer.Sound.play(self.eat_sound)##########SOUND
            self.pelletsEaten += 1
